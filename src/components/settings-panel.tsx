...
import { ElementsForm } from "@/components/forms/elements-form";
import {
  VerticalTabs,
  VerticalTabsContent,
  VerticalTabsList,
...
import { SwipeIndicatorForm } from "@/components/forms/swipe-indicator-form";
      ...
      <div className="flex flex-row h-full w-full">
        <ScrollArea className="border-r h-full bg-muted">
          <VerticalTabsList className="grid grid-cols-1 gap-2 w-20 rounded-none">
            ...
            <VerticalTabTriggerButton tabInfo={ALL_FORMS.elements} />
          </VerticalTabsList>
        </ScrollArea>
        <div className="p-2 flex flex-col items-stretch w-full ">
          ...
          <VerticalTabsContent
            value={ALL_FORMS.elements.value}
            className="mt-0 border-0 p-0 m-4"
          >
            <h4 className="text-xl font-semibold">
              {ALL_FORMS.elements.name}
            </h4>
            <Separator className="mt-2 mb-4"></Separator>
            <ElementsForm />
          </VerticalTabsContent>
      ...
      <div className="flex flex-col h-full ">
        <ScrollArea className=" border-b h-full bg-muted">
          <TabsList className="grid grid-cols-5 gap-2 h-20 rounded-none">
            ...
            <HorizontalTabTriggerButton tabInfo={ALL_FORMS.elements} />
          </TabsList>
        </ScrollArea>
