...
// New path types for text formatting
export type TextFormattingFieldPath =
  `slides.${number}.elements.${number}.formatting`;
export type TextFormattingRangesFieldPath =
  `slides.${number}.elements.${number}.formatting.ranges`;

// Path types for tracking text selection for formatting
export type TextSelectionInfo = {
  fieldPath: TextTextFieldPath;
